...
export default function SelectForm({choices,onSelect, title,v=true}) {
  ...
  return (
        <div className="mb-4 w-full">
            ...
            <select name={title}  className="form-select appearance-none block w-full px-3 py-1.5 font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0
