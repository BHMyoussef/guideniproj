    ...
    <section className="container bg-white py-20 lg:py-[120px] overflow-hidden relative">
      ...
      <div className={`flex flex-wrap lg:justify-between -mx-4 ${currentLang=="ar"?"flex-reverse lg:flex-row-reverse text-right":""} `}>
         <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div className={`max-w-[570px] mb-12 lg:mb-0 ${currentLang=="ar"?"flex-reverse lg:flex-row-reverse":""}`}>
               ...
               <div className={`flex mb-8 max-w-[370px] w-full ${currentLang=='ar'?"flex-row-reverse":""}`}>
                  <div className={`max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center  overflow-hidden bg-primary bg-opacity-5 text-primary rounded ${currentLang=='ar'?"flex-row-reverse ml-8":"mr-8"}`} >
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1">{contact?.location}</h4>
               ...
               <div className={`flex mb-8 max-w-[370px] w-full ${currentLang=='ar'?"flex-row-reverse":""}`}>
                 <div className={`max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center  overflow-hidden bg-primary bg-opacity-5 text-primary rounded ${currentLang=='ar'?"flex-row-reverse ml-8":"mr-8"}`} >
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1">{contact?.phone}</h4>
                     <p className="text-base text-body-color">(+212)6 12345678</p>
                  </div>
               </div>
               <div className={`flex mb-8 max-w-[370px] w-full  ${currentLang=='ar'?"flex-row-reverse":""}`}>
                 <div className={`max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center  overflow-hidden bg-primary bg-opacity-5 text-primary rounded  ${currentLang=='ar'?"flex-row-reverse ml-8":"mr-8"}`} >
               ...
               <form>
                  ...
                  <div className="mb-6">
                     <textarea
                        ...
                        className=" w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] resize-none outline-none focus-visible:shadow-none focus:border-primary "></textarea>
                  </div>
                  <div>
